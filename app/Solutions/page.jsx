    ...
    items: [
      ...
      // Cashew
      {
        ...
        images: [
          ...
          {
            src: "/NewImages/sheelinput.jpeg", // Add image path if available
            title: " input Material ",
            details: {
              points: [
                "Removes defective kernels, shell fragments, and foreign particles using AI and vision-based detection",
                "Ensures uniform color and quality for premium-grade cashew Shell products",
                "Enhances processing efficiency and reduces manual sorting requirements",
                "Supports high-capacity throughput for commercial nut processing facilities",
              ],
              description: " ",
          ...
          {
            src: "/NewImages/sheelaccept.jpeg", // Add image path if available
            title: " Accept ",
            details: {
              points: [
                "Removes defective kernels, shell fragments, and foreign particles using AI and vision-based detection",
          ...
          {
            src: "/NewImages/cashwerejection1.jpeg", // Add image path if available
            title: "  Rejection ",
            details: {
              points: [
                "Removes defective kernels, shell fragments, and foreign particles using AI and vision-based detection",
          ...
          {
            src: "/NewImages/cashweinput1.jpeg", // Add image path if available
            title: " input Material ",
            details: {
              points: [
                "Removes defective kernels, shell fragments, and foreign particles using AI and vision-based detection",
          ...
          {
            src: "/NewImages/cashweaccept.jpeg", // Add image path if available
            title: " Accept ",
            details: {
              points: [
                "Removes defective kernels, shell fragments, and foreign particles using AI and vision-based detection",
          ...
          {
            src: "/NewImages/cashwerejection.jpeg", // Add image path if available
            title: "  Rejection ",
            details: {
              points: [
                "Removes defective kernels, shell fragments, and foreign particles using AI and vision-based detection",
...
// 
      ...
      //Done
      {
        ...
        images: [
          {
            src: "/NewImages/maizeInput.jpeg", // Add image path if available
            title: "Input Material",
            details: {
              points: [
          ...
          {
            src: "/NewImages/maizeaccept.jpeg", // Add image path if available
            title: " Accept",
            details: {
              points: [
                "Removes damaged kernels, husk remnants, and foreign particles using AI and vision-based detection",
          ...
          {
            src: "/NewImages/maizerejected.jpeg", // Add image path if available
            title: " Rejection",
            details: {
              points: [
                "Removes damaged kernels, husk remnants, and foreign particles using AI and vision-based detection",
