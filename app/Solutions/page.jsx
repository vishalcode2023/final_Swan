    ...
    items: [
      ...
      //Chillies
      {
        ...
        images: [
          ...
          {
            src: "https://res.cloudinary.com/dysyaxsnc/image/upload/v1755071236/WhatsApp_Image_2025-08-13_at_1.16.29_PM_omocaz.jpg", // Add image path if available
            title: "Accept",
            details: {
              points: [
                "Removes discolored, damaged, and foreign particles using AI and vision-based detection",
                ...
                <div className="flex flex-col lg:flex-row gap-8 w-full">
                  <div className="lg:w-1/2">
                    <Image
                      ...
                      height={600}
                      className="rounded-lg object-cover w-full h-auto" // Make sure image scales within container
                    />
                  ...
                  <div className="lg:w-1/2">
                    ...
                    <div className="mt-8">
                      ...
                      {/* Single button for the whole section */}
                      {/* <div className="mt-4 my-20 flex justify-center">
                        <button className="bg-gradient-to-r from-green-400 to-blue-400 px-2 text-white  py-2 rounded-md transition">
                          <a href="/ColorSorters/Chute-type">View Product</a>
                        </button>
                      </div> */}
                    </div>
                  </div>
