    ...
    "items": [
      {
        ...
        "images": [
          ...
          {
            "src": "https://ik.imagekit.io/bxhlcmkcf/Urent/img3.png?updatedAt=1756188606029",
            "title": "Star Anise",
            "details": {
              "points": [
                "Star-shaped spice with a licorice flavor",
          ...
          {
            "src": "https://ik.imagekit.io/bxhlcmkcf/Urent/img2.png?updatedAt=1756188555311",
            "title": "Mustard Seeds",
            "details": {
              "points": [
                "Pungent and bitter taste",
                        ...
                        {(selectedItem.recommended || []).map((rec, idx) => (
                          ...
                          >
                            <Image
                              ...
                              width={80}
                              height={60}
                              className="rounded-md object-cover h-60 w-64"
                            />
                          </div>
                        ))}
                      </div>
